...
- [x] **CONT-03**: Contract pills (1-7 years) visible on player cards in Rosters tab
...
- [x] **OFF-02**: Power Rankings, Scoring, Analytics, Pulse show last-completed-season data when current season has zero games
- [x] **OFF-03**: Draft, Moves, and Rivals tabs show historical data instead of empty states when current season has no data
- [x] **OFF-04**: Trades tab defaults to ALL years instead of current empty season
- [x] **OFF-05**: D.records populates week numbers correctly — no null weeks producing WkNaN in ticker or Trophies
- [x] **OFF-06**: Awards, GM Dashboard, and Chronicle use historical/all-time data for offseason narratives
...
- [x] **POLI-01**: Every existing tab reviewed and polished to broadcast-quality standard
- [x] **POLI-02**: Constitution tab polished and complete
- [x] **POLI-03**: Rafters tab polished and complete
...
| OFF-02 | Phase 3.1 | Complete |
| OFF-03 | Phase 3.1 | Complete |
| OFF-04 | Phase 3.1 | Complete |
| OFF-05 | Phase 3.1 | Complete |
| OFF-06 | Phase 3.1 | Complete |
...
| POLI-01 | Phase 6 | Complete |
| POLI-02 | Phase 6 | Complete |
| POLI-03 | Phase 6 | Complete |
