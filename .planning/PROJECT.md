...
- **Design identity:** Modern broadcast aesthetic that beats ESPN, not just parodies it. Dark warm theme (#120e0c base, #cc0000 accent red, #ffcc00 gold). Space Grotesk for display headings (replacing Oswald — too "sports template"), Inter for body, DM Sans for stats/numbers (replacing JetBrains Mono — too "developer tool"). Draft board cards are the visual gold standard — gradient backgrounds, position badges, headshots, layered information. Font weights 600-800 on headings for authority.
